...
# Combines user input features will entire penguins dataset
...
if upload_file is not None:
    ...
    st.write('Awaiting for CSV file to be uploaded. Currently using example input parameters (Shown below).')
    st.write(df)
