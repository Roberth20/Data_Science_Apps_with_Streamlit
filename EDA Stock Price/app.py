...
st.markdown('''
            ...
            and its corresponding **stock closing price** (year-to-date)
...
def filedownload(df):
    ...
    href = f'<a href="data:file/csv;base64,{b64}" download="S&P 500.csv">Download CSV File</a>'
    return href
...
def price_plot(symbol):
    ...
    ax.plot(df.Date, df.Close, color='skyblue')
